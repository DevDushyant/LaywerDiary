...
{
    public class QGetUserCaseDetail : IRequest<PaginatedResult<GetUserCaseDetail>>
    {
        ...
        public QGetUserCaseDetail(int PageNumber,int PageSize)
        {
            this.PageNumber = PageNumber;
            this.PageSize = PageSize;
        }
    }
    public class QGetUserCaseDetailHandler : IRequestHandler<QGetUserCaseDetail, PaginatedResult<GetUserCaseDetail>>
    {
        ...
        public QGetUserCaseDetailHandler(ICaseNatureCacheRepository repoNature,
        ...
        public async Task<PaginatedResult<GetUserCaseDetail>> Handle(QGetUserCaseDetail request, CancellationToken cancellationToken)
        {
            Expression<Func<CaseEntity, GetUserCaseDetail>> expression = e => new GetUserCaseDetail
            {
                Id = e.Id,
