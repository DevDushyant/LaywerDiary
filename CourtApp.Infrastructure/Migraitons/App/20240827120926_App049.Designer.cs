...
namespace CourtApp.Infrastructure.Migraitons.App
{
    ...
    [Migration("20240827120926_App049")]
    partial class App049
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourtApp.Domain.Entities.FormBuilder.FormFieldMappingEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CourtApp.Domain.Entities.FormBuilder.FormFieldMappingEntity", b =>
                {
                    b.OwnsMany("CourtApp.Domain.Entities.FormBuilder.FormFieldValueEntity", "FieldDetails", b1 =>
                        {
                            b1.Property<Guid>("FormFieldMappingEntityId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("FormFieldMappingEntityId", "Id");

                            b1.ToTable("case_ff_mapping");

                            b1.ToJson("FieldDetails");

                            b1.WithOwner()
                                .HasForeignKey("FormFieldMappingEntityId");
                        });
