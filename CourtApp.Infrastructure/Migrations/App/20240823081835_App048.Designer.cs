...
namespace CourtApp.Infrastructure.Migrations.App
{
    ...
    [Migration("20240823081835_App048")]
    partial class App048
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourtApp.Domain.Entities.DynamicForms.FormBuilderEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CourtApp.Domain.Entities.DynamicForms.FormBuilderEntity", b =>
                {
                    b.OwnsOne("CourtApp.Domain.Entities.DynamicForms.FormFields", "FieldsDetails", b1 =>
                        {
                            ...
                            b1.OwnsMany("CourtApp.Domain.Entities.DynamicForms.FieldDetails", "Fields", b2 =>
                                {
                                    b2.Property<Guid>("FormFieldsFormBuilderEntityId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("FormFieldsFormBuilderEntityId", "Id");

                                    b2.ToTable("m_frm_types");

                                    b2.WithOwner()
                                        .HasForeignKey("FormFieldsFormBuilderEntityId");
                                });
