...
namespace CourtApp.Infrastructure.Migrations.App
{
    ...
    [Migration("20240629112554_App038")]
    partial class App038
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourtApp.Domain.Entities.LawyerDiary.CaseDetailAgainstEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CourtApp.Domain.Entities.LawyerDiary.CaseTitleEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CourtApp.Domain.Entities.LawyerDiary.ClientEntity", b =>
                {
                    ...
                    b.Property<Guid?>("OppositCounseId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CaseFeeId");

                    b.HasIndex("CaseId");

                    b.HasIndex("OppositCounseId");
            ...
            modelBuilder.Entity("CourtApp.Domain.Entities.LawyerDiary.CaseDetailAgainstEntity", b =>
                {
                    b.HasOne("CourtApp.Domain.Entities.LawyerDiary.CaseDetailEntity", null)
            ...
            modelBuilder.Entity("CourtApp.Domain.Entities.LawyerDiary.ClientEntity", b =>
                {
                    b.HasOne("CourtApp.Domain.Entities.Account.CaseFeeEntity", "CaseFee")
                        .WithMany()
                        .HasForeignKey("CaseFeeId");
                    ...
                    b.HasOne("CourtApp.Domain.Entities.LawyerDiary.LawyerMasterEntity", "OppositCounse")
                        .WithMany()
                        .HasForeignKey("OppositCounseId");

                    b.Navigation("Case");

                    b.Navigation("CaseFee");

                    b.Navigation("OppositCounse");
                });
