...
namespace CourtApp.Infrastructure.Migrations
{
    ...
    [Migration("20240330163118_App003")]
    partial class App003
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourtApp.Domain.Entities.LawyerDiary.AgainstCaseDetails", b =>
                {
                    ...
                    b.Property<int>("CisNumber")
                        .HasColumnType("integer");

                    b.Property<int>("CisYear")
                        .HasColumnType("integer");

                    b.Property<int>("CnrNumber")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CourtApp.Domain.Entities.LawyerDiary.AgainstCaseDetails", b =>
                {
                    b.HasOne("CourtApp.Domain.Entities.LawyerDiary.CaseEntity", null)
                        .WithMany("AgainstCaseDetails")
            ...
            modelBuilder.Entity("CourtApp.Domain.Entities.LawyerDiary.CaseEntity", b =>
                {
                    b.Navigation("AgainstCaseDetails");
                });
