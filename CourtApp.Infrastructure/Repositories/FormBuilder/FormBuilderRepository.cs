...
namespace CourtApp.Infrastructure.Repositories.DynamicForms
{
    public class FormBuilderRepository:IFormBuilderRepository
    {
        ...
        public async Task DeleteAsync(FormBuilderEntity entity)
        {
            ...
            await _distributedCache.RemoveAsync(CacheKeys.FormBuilderCacheKeys.ListKey);
            await _distributedCache.RemoveAsync(CacheKeys.FormBuilderCacheKeys.GetKey(entity.Id));
        }
