...
namespace CourtApp.Infrastructure.Repositories.FormBuilder
{
    public class FormTempMappingRepository : IFormTempMappingRepository
    {
        ...
        public async Task DeleteAsync(FormTemplateMappingEntity entity)
        {
            ...
            await _distributedCache.RemoveAsync(CacheKeys.FormTempMappingCacheKeys.ListKey);
            await _distributedCache.RemoveAsync(CacheKeys.FormTempMappingCacheKeys.GetKey(entity.Id));
        }
