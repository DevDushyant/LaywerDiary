...
namespace CourtApp.Infrastructure.Repositories.FormBuilder
{
    public class CaseDraftingRepository : ICaseDraftingRepository
    {
        ...
        public async Task DeleteAsync(DraftingDetailEntity entity)
        {
            ...
            await _distributedCache.RemoveAsync(CacheKeys.DraftingDetailCacheKeys.ListKey);
            await _distributedCache.RemoveAsync(CacheKeys.DraftingDetailCacheKeys.GetKey(entity.Id));
        }
