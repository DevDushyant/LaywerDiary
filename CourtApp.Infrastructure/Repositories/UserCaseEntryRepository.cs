...
{
    public class UserCaseEntryRepository : IUserCaseRepository
    {
        private readonly IRepositoryAsync<CaseEntity> _repository;
        private readonly IDistributedCache _distributedCache;
        public UserCaseEntryRepository(IRepositoryAsync<CaseEntity> _repository, IDistributedCache _distributedCache)
        {
